...
pickle.dump(open('index2word.obj', 'r'))
pickle.dump(open('word2index.obj', 'r'))
...
def train_the_model():
    ...
    pickle.dump(chat_model, open('chat_model.obj', 'w'))

def test_the_model():
    chat_model = pickle.load(open('chat_model.obj', 'r'))
    index2word = pickle.load(open('index2word.obj', 'r'))
    word2index = pickle.load(open('word2index.obj', 'r'))
    evaluateInput(chat_model,index2word,word2index)
